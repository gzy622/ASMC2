import {
  $, LS, KEYS, Toast, ColorUtil, IdGenerator, Validator,
  DEFAULT_ROSTER, createPlaceholderStudentName
} from './utils.js'
import { APP_CONFIG, TIMER_DELAY, CACHE_CONFIG, GRID_CONFIG } from './constants.js'
...
const UI = {
  ...
  init() {
    const BackHandler = globalThis.BackHandler
    if (BackHandler && BackHandler.init) BackHandler.init()
